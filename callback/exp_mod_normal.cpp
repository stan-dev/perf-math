...
static void exp_mod_normal_lpdf_data(benchmark::State& state) {
  auto run = [](const auto&... args) {
    return exp_mod_normal_lpdf(args...);
  };
...
static void exp_mod_normal_cdf_data(benchmark::State& state) {
  auto run = [](const auto&... args) {
    return exp_mod_normal_cdf(args...);
  };
...
static void exp_mod_normal_lcdf_data(benchmark::State& state) {
  auto run = [](const auto&... args) {
    return exp_mod_normal_lcdf(args...);
  };
...
static void exp_mod_normal_lccdf_data(benchmark::State& state) {
  auto run = [](const auto&... args) {
    return exp_mod_normal_lccdf(args...);
  };
...
int end_val = 1024;
BENCHMARK(toss_me);
BENCHMARK(exp_mod_normal_lpdf)->RangeMultiplier(2)->Range(start_val, end_val)->UseManualTime();
BENCHMARK(exp_mod_normal_cdf)->RangeMultiplier(2)->Range(start_val, end_val)->UseManualTime();
BENCHMARK(exp_mod_normal_lcdf)->RangeMultiplier(2)->Range(start_val, end_val)->UseManualTime();
BENCHMARK(exp_mod_normal_lccdf)->RangeMultiplier(2)->Range(start_val, end_val)->UseManualTime();
BENCHMARK(exp_mod_normal_lpdf_data)->RangeMultiplier(2)->Range(start_val, end_val)->UseManualTime();
BENCHMARK(exp_mod_normal_cdf_data)->RangeMultiplier(2)->Range(start_val, end_val)->UseManualTime();
BENCHMARK(exp_mod_normal_lcdf_data)->RangeMultiplier(2)->Range(start_val, end_val)->UseManualTime();
BENCHMARK(exp_mod_normal_lccdf_data)->RangeMultiplier(2)->Range(start_val, end_val)->UseManualTime();
BENCHMARK_MAIN();
